...
function create (banner_style, versione_testo, path_policy, opzioni, stile = 2, locale = 'it') {
    ...
    const stili = set_stili(stile, versione_testo, banner_style);
    ...
    banner_template = banner_template.replace(/(__path__|\[path])/g, path_policy);
 ...
 * @param versione
 */
function set_stili (stile, versione, banner_style) {
